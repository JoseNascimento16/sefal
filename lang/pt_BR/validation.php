...
return [
    ...
    | de validação. Algumas regras possuem várias versões (string/numérico/etc).
    |
    */
    ...
    */
    ...
    /*
    | Sem o nome amigável aqui, o Laravel usa o NOME CRU DA COLUNA na mensagem — sem acento e com
    | "_" virando espaço: "O campo descricao...", "O campo ocorrencia complemento...". Ao criar
    | tela/validação nova, cadastre os campos dela nesta lista.
    */
    'attributes' => [
        'name' => 'nome',
        'login' => 'matrícula',
