 ...
 * conferência do gestor — a razão de a fila existir — deixava de acontecer.
 *
 ...
 * desfazer o que o gestor decidiu na tela). Então quem já rodou a semente antiga continuaria com
 ...
 * `visivel=1, habilitado=1, apenas_leitura=0, incluir=0, excluir=0`. Se o gestor mexeu em
...
return new class extends Migration
{
     ...
     * exatamente como esta migration a deixou. Rollback que reabre gravação para quem o gestor
     * depois restringiu de propósito seria pior do que não voltar nada.
     */
