# Denúncias das ouvidorias (e-Salvador e Salvador Digital)
...
- o **número que o canal lhe deu** (`ESL-…` no e-Salvador, `156-…` no Salvador Digital), em coluna
  própria da grade;
...
No Salvador Digital a pessoa pode não querer se identificar (medo de represália é o motivo mais comum),
...
origens, e separar a permissão do e-Salvador da do Salvador Digital seria uma decisão que ninguém precisa
tomar.
...
| **DEN-0030** · mesas e som em Itapuã | Salvador Digital | `gestor1`, `administrativo1`, `admin` | **retorno vencido**: notificação de 48 h com o notificado **recusando assinar**, e o retorno encontrando o ponto igual — a denúncia volta ao Chefe de Setor |
...
| **DEN-0033** · carrinho na garagem | Salvador Digital | `gestor2`, `administrativo1`, `admin` | o **caminho comum**: orientou, o ambulante deslocou o carrinho, **nenhum documento** |
...
| **DEN-0032** · mesas de bar no Cabula | Salvador Digital | `gestor3`, `administrativo1`, `admin` | a denúncia **de ponta a ponta**, em sete passos: integração › triagem › Chefe de Setor › vistoria › notificação › retorno › conclusão, com o notificado **cumprindo** e nenhuma penalidade |
| **DEN-0027** · banca na faixa de pedestre | Salvador Digital | **só** `administrativo1` e `admin` | é da **Área 4**, que não tem Chefe de Setor com conta: a prova visível de que o recorte por área funciona |
...
| **DEN-0035** · carrinho em frente à escola de Sussuarana | Salvador Digital | `administrativo1`, `admin` | a **segunda notificação com prazo correndo**, deliberadamente diferente da DEN-0029 na leitura do impresso: caixa que pede **complemento à mão** ("Comparecer a SEMOP no Setor ____"), a **20ª caixa "Outros"** (campo livre) preenchida, outras penalidades, prazo de **10 dias** e uma testemunha **não colhida**. Chegou a campo pela **Operação Volta às Aulas** |
| **DEN-0036** · lona na Avenida Joana Angélica | Salvador Digital | `administrativo1`, `admin` | regularização no local numa área de **corredor** (Itinerante), vinda de denúncia **anônima**, com a vistoria assinada pela **segunda fiscal** da equipe |
...
| **DEN-0038** · som de madrugada em Stella Maris | Salvador Digital | `gestor1`, `administrativo1`, `admin` | **nada encontrado** com a ida no **dia e no horário certos**: o ponto não existe mais, e o registro diz por que não é caso de nova ida. É também a **troca de equipe** (passada à **Noturna**), com a justificativa escrita |
...
| **DEN-0024** · evento na Rua Chile | Salvador Digital | `gestor2`, `administrativo1`, `admin` | a **outra saída do Chefe de Setor**: anexar à **Rotina Centro**, com região, período e foco da operação. E o **bairro compartilhado** na triagem (Comércio está na Área 1 e na Itinerante) com a escolha registrada |
...
| **DEN-0028** · mesas na ciclovia da Avenida Sete | Salvador Digital | `administrativo1`, `admin` | a mesma vistoria em andamento no canal do **telefone** e numa área de **corredor**, com o responsável ainda não localizado |
...
| **DEN-0026** · banca sem endereço em São Marcos | Salvador Digital | **só** `administrativo1` e `admin` | o **arquivamento na triagem**, com o registro do que **reabre o caso** (complemento de endereço enviado pelo canal) |
...
- **Contrato das integrações** do e-Salvador e do Salvador Digital (endpoints, autenticação, campos,
