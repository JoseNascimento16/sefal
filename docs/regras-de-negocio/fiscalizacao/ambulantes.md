...
|---|---|---|---|---|
| 09/09/2026 | José Nascimento | Ambulantes | **A aba "Localizar" ficou enxuta** (padrão [`docs/padroes/listagem-clean.md`](../../padroes/listagem-clean.md)): **Ambulante · Apelido · Atividade · Permissão · Situação**. O **apelido** ganhou coluna própria em vez de ser a sub-linha embaixo do nome — é ele, com a foto, a identidade prática de campo; o código do cadastro desceu com ela. Documento e validade da permissão saíram da grade porque são chaves de **busca** (a barra casa o documento, e "permissão vencida" é faceta), e estão no cadastro aberto e no arquivo. A coluna Permissão virou **texto**, para a linha ter um selo só — o da situação. | Ordem do dono (09/09/2026): _"as listagens estão muito poluídas, muita informação quebrando linha de forma irregular… deixe a informação detalhada para quando o usuário clicar"_. A régua e o porquê de cada item ficam em [`docs/padroes/listagem-clean.md`](../../padroes/listagem-clean.md) — este doc aponta para lá em vez de repetir a régua. |
...
| 25/09/2026 | José Nascimento | Ambulantes | O **líder de equipe** passa a consultar o cadastro (só leitura), para abrir o prontuário que o mapa oferece. Migration `2026_09_25_160000_lider_consulta_ambulantes`. | Retorno do dono. |
