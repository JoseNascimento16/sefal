...
| 25/09/2026 | José Nascimento | Mapa ao Vivo | O **líder de equipe** passa a abrir o mapa, vendo só as fiscalizações das equipes dele e dos bairros das áreas delas (recorte no servidor, `MapaDaCidade::recorteDoLider`). | Pedido do dono. |
| 25/09/2026 | José Nascimento | Mapa ao Vivo | O recorte do líder alcança também os **pinos de ambulante** (só os dos bairros das áreas dele) e o **filtro de equipes** (só as dele); no Mapa de Calor, os bairros desenhados. O líder passa a **consultar** o prontuário do ambulante que o mapa abre. | Retorno do dono: o líder ainda via as outras equipes, e era barrado no prontuário. |
