...
| 24/09/2026 | José Nascimento | Fiscalizações | **O líder não encerra o retorno.** A folha "Decidir sobre N retornos" perde o cartão **Dar ciência**; ficam duas saídas: **Mandar a equipe voltar** (justificativa obrigatória, marcada com asterisco: "Mandar a equipe de volta consome tempo de trabalho, portanto seja específico nessa justificativa") e **Encaminhar ao Chefe de Setor** (era "Devolver ao Chefe de Setor"; o caso volta para o chefe deliberar — responder à Coordenadoria ou pedir nova fiscalização —, motivo obrigatório com asterisco). O servidor recusa a ciência vinda do líder com o motivo escrito; o Chefe de Setor e o administrador continuam podendo registrá-la pela rota. | Pedido do dono: o líder decide, e não pode arquivar demanda. |
| 24/09/2026 | José Nascimento | Fiscalizações | **A FISCALIZAÇÃO passa a ser o ciclo, não a vistoria.** Cada linha da tela era uma vistoria (uma ida ao ponto); agora é a Fiscalização — nova entidade `fiscalizacao_ciclos` (`CicloDeFiscalizacao`), à qual as vistorias pertencem (`fiscalizacoes.ciclo_id`). **Nasce** quando o Chefe de Setor encaminha a demanda ao líder (e quando o líder registra o Fala Salvador); **com a Equipe**, o líder a encaminha aos fiscais (ou inclui em operação), lê o retorno e pode **mandar a equipe voltar** (nova vistoria na MESMA Fiscalização); o **Desfecho** muda conforme avança (Aguardando envio à equipe → Com a equipe em campo → desfecho da última vistoria). **Não existe "dar ciência"** (rota removida): o líder **encaminha ao Chefe de Setor** e ela vai para a aba **Encaminhadas** (posse Chefe; a demanda volta à mesa do chefe com o resultado no trâmite). Quando o chefe **devolve o processo à origem** (e-Salvador, Fala Salvador, e-Protocolo; avulsa: processo ou encerramento), todas as Fiscalizações da demanda vão para o **Arquivo** (era "Acervo"); a sem processo (ronda, operação) o chefe arquiva. Um novo encaminhamento do chefe abre uma Fiscalização **irmã**. Abas: Em andamento · Encaminhadas · Arquivo. Grade: Fiscalização, Demanda, Equipe, Desfecho, **Posse atual** (Equipe / Chefe de Setor). Detalhe: processo (link para a Caixa), vistorias inteiras (relato, fotos, documento), irmãs. Contador do menu: líder = o que pede decisão dele; chefe = as Encaminhadas. O chefe não responde à origem com a Fiscalização ainda com a equipe. Migration reconstrói as Fiscalizações do que já existia; "Devolvida à coordenação" vira "Encaminhada ao Chefe de Setor". | Decisão do dono em 24/09/2026: Fiscalização é o conjunto de atos que põe a demanda em prática (Líder › equipes › Líder › Chefe › Coordenadoria); tudo rastreável durante o vai e vem do processo. |
| 24/09/2026 | José Nascimento | Fiscalizações | **Posse atual distingue o líder da equipe.** Com a equipe, a posse é **Líder de Equipe** quando a decisão é dele (Fiscalização que chegou do chefe e espera o envio aos fiscais, ou retorno de campo esperando a leitura) e **Equipe** quando os fiscais estão com o ponto; **Chefe de Setor** depois do encaminhamento. Semeador de demonstração `FiscalizacoesParaOLiderSeeder` (fora do boot): Fiscalizações vindas do chefe e retornos concluídos pela equipe, para o líder encaminhar. | Pedido do dono em 24/09/2026: "Com: Equipe" escondia que a próxima ação era do líder. |
| 25/09/2026 | José Nascimento | Fiscalizações | As **fotos** de cada vistoria e os **anexos da demanda** passam a ser vistos (miniatura) e baixados no detalhe da Fiscalização — rota `fiscalizacoes/fotos/{id}`, que confere a permissão da tela e o recorte do líder; só imagem e PDF abrem no navegador, o resto é baixado (`nosniff`). Arquivo ausente do disco aparece dito, não como link quebrado. O botão de fechar o detalhe vira **Voltar**. | Pedido do dono: "deve ser possível visualizar e baixar os arquivos da fiscalização/processo". |
