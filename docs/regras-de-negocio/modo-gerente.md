...
| 25/09/2026 | José Nascimento | Modo Gerente | Como no Codecon: botão **Modo Gerente** no pé do menu liga e desliga (estado na sessão); com ele ligado, cada item e pasta do menu mostra uma **chave** que abre as permissões só daquela tela (a pasta, das telas dela); "Ver todas as telas" abre a matriz inteira. O item do menu saiu (`oculto`). Quem liga: administrador ou a conta com a marca "Pode ativar o Modo Gerente". | Pedido do dono. |
